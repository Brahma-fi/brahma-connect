...
if (descriptor?.configurable) {
  ...
  Object.assign(window.ethereum, { request: injectedProvider.request })
  Object.assign(window.web3.currentProvider, {
    request: injectedProvider.request,
  })
}
...
overrideMetamaskAnnouncement(injectedProvider)
announceEip6963Provider(injectedProvider)
